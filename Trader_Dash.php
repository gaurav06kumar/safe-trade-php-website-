...
<nav class="navbar navbar-expand-md bg-light navbar-light">
        ...
        <div class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                <a class="nav-link" href="My_Estimate.php">My Estimate </a></li>
                <li class="nav-item">
                <a class="nav-link" href="Trader_Profile.php">Profile </a></li>
                <li class="nav-item">
                <a class="nav-link" href="Trader_LogOut.php">LogOut </a></li>
...
<div class="Container" align="center">
  ...
  <h1 id="h">Welcome <?php  echo $result->getName();  ?></h1>
